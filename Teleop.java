...
public class Teleop extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        vertTrans.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        vertTrans.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        vertTrans.setMode(DcMotor.RunMode.RUN_TO_POSITION);

        horizTrans = hardwareMap.get(DcMotor.class, "horizTrans");
        horizTrans.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        horizTrans.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        horizTrans.setMode(DcMotor.RunMode.RUN_TO_POSITION);
...
//            }
            ...
            horizTrans.setPower(gamepad2.right_stick_y);
            ...
            if (gamepad2.left_stick_y > 0) {
                ...
                vertTrans.setTargetPosition(-4600);
            }
            vertTrans.setPower(-gamepad2.left_stick_y);
